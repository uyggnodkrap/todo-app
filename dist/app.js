...
class TodoApp {
    ...
    async load() {
        ...
        this.todos = (data !== null && data !== void 0 ? data : []).map((row) => ({
            id: row.id,
            text: row.text,
    ...
    render() {
        ...
        const sorted = [...this.todos].sort((a, b) => PRIORITY_ORDER[a.priority] - PRIORITY_ORDER[b.priority]);
        sorted.forEach((todo) => {
